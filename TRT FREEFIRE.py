...
try:
	prox= requests.get('https://raw.githubusercontent.com/Ramxantanha/data/galib/proxies.txt').text
...
android_models=[]
try:
	xx = requests.get('https://raw.githubusercontent.com/Ramxantanha/data/galim /strings.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://raw.githubusercontent.com/Ramxantanha/data/Mainul/ua.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
